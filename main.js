...
// - インスタンスは変数 `me` に代入する
const me = new Person("みー", 1, "女性", "30cm", "4kg");

// 課題3: 課題2で生成したインスタンスの情報をconsole.logを使って、「名前」「年齢」「性別」「身長」「体重」が正しくセットされていることを確認する
console.log("me.nameはみーであるべき: " + me.name);
console.log("me.ageは1であるべき: " + me.age);
console.log("me.genderは女性であるべき: " + me.gender);
console.log("me.heightは30cmであるべき: " + me.height);
console.log("me.weightは4kgであるべき: " + me.weight);
